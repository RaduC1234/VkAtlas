...
namespace Atlas {
    ...
    // GPU-side object data for shader access (must match shader struct exactly)
    ...
    public:
        ...
        // Call before render() each frame — scans registry, registers new assets, fills GPU buffers
