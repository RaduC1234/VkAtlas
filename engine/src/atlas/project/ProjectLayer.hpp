...
namespace Atlas {
    ...
    public:
        ProjectLayer(Renderer &renderer, AssetManager &assets, std::filesystem::path manifestPath, std::filesystem::path moduleOverride = {}, std::filesystem::path startupLevelOverride = {});

        void onAttach() override;
        void onDetach() override;
        void onUpdate(float deltaTime) override;
        void onRender(FrameContext frameContext) override;
        void loadProject(std::filesystem::path newManifestPath, std::filesystem::path newModuleOverride = {}, std::filesystem::path newStartupLevelOverride = {});
